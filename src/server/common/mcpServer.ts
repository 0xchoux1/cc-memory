/**
 * Shared McpServer factory for cc-memory
 * Creates and configures McpServer instances for both stdio and HTTP transports
 */
...
export function createMcpServer(options: CreateMcpServerOptions): McpServer {
  ...
  // Register resources
  registerResources(server, memoryManager);

  // Register prompts
  registerPrompts(server, memoryManager);

  return server;
}

/**
 * Register all tools on the McpServer
 */
function registerTools(server: McpServer, handlers: ReturnType<typeof createToolHandlers>): void {
 ...
 */
function registerResources(server: McpServer, memoryManager: MemoryManager): void {
  server.resource(
    'memory://working',
    'memory://working',
    async () => {
...
/**
 * Register prompts on the McpServer
 */
function registerPrompts(server: McpServer, memoryManager: MemoryManager): void {
  server.prompt(
    'recall_context',
